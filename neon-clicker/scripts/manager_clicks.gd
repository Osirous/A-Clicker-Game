...
func click_critical_damage() -> float:
	return calculate_linear_upgrade(PlayerData.click_crit_damage, PlayerData.click_crit_damage_upgrade, PlayerData.CRITICAL_BONUS_AT_LEVEL_ZERO, PlayerData.CRITICAL_BONUS_PER_LEVEL_INCREMENT)
...
func click_accuracy() -> int:
	return calculate_quadratic_upgrade(PlayerData.click_accuracy, PlayerData.click_accuracy_upgrade, PlayerData.ACCURACY_QUADRATIC_COEFFICIENT, PlayerData.ACCURACY_BONUS_OFFSET)

func click_min_hit_chance() -> int:
	return calculate_quadratic_upgrade(PlayerData.min_chance_to_hit, PlayerData.min_chance_to_hit_upgrade, PlayerData.MIN_HIT_QUADRATIC_COEFFICIENT, PlayerData.MIN_HIT_BONUS_OFFSET)

func click_max_hit_chance() -> int:
	return calculate_quadratic_upgrade(PlayerData.max_chance_to_hit, PlayerData.max_chance_to_hit_upgrade, PlayerData.MAX_HIT_QUADRATIC_COEFFICIENT, PlayerData.MAX_HIT_BONUS_OFFSET)

func click_min_critical_chance() -> int:
	return calculate_quadratic_upgrade(PlayerData.min_critical_hit_chance, PlayerData.min_critical_hit_chance_upgrade, PlayerData.MIN_CRIT_QUADRATIC_COEFFICIENT, PlayerData.MIN_CRIT_BONUS_OFFSET)

func click_max_critical_chance() -> int:
	return calculate_quadratic_upgrade(PlayerData.max_critical_hit_chance, PlayerData.max_critical_hit_chance_upgrade, PlayerData.MAX_CRIT_QUADRATIC_COEFFICIENT, PlayerData.MAX_CRIT_BONUS_OFFSET)
